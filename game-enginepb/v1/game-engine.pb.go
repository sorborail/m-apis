...
func (m *SetScoreResponse) GetResult() bool {
	if m != nil {
		return m.Result
	}
	return false
...
func init() {
	proto.RegisterType((*GetSizeRequest)(nil), "gameengine.GetSizeRequest")
	proto.RegisterType((*GetSizeResponse)(nil), "gameengine.GetSizeResponse")
	proto.RegisterType((*SetScoreRequest)(nil), "gameengine.SetScoreRequest")
	proto.RegisterType((*SetScoreResponse)(nil), "gameengine.SetScoreResponse")
}
...
var fileDescriptor_383212ef93ee0b9b = []byte{
	...
	,
}
...
func (c *gameEngineClient) GetSize(ctx context.Context, in *GetSizeRequest, opts ...grpc.CallOption) (*GetSizeResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gameengine.GameEngine/GetSize", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *gameEngineClient) SetScore(ctx context.Context, in *SetScoreRequest, opts ...grpc.CallOption) (*SetScoreResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gameengine.GameEngine/SetScore", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GameEngine_GetSize_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gameengine.GameEngine/GetSize",
	}
...
func _GameEngine_SetScore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gameengine.GameEngine/SetScore",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _GameEngine_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gameengine.GameEngine",
